        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (encodedImageString !=null){
                    ...
                    Toast.makeText(DataInsert.this, "Please Select Image", Toast.LENGTH_SHORT).show();
            ...
            new ActivityResultCallback<Uri>() {
                ...
                public void onActivityResult(Uri uri) {
                    ...
                    try {
                        ...
                        Toast.makeText(DataInsert.this, "error", Toast.LENGTH_SHORT).show();
                    }
                }
            });
 ...
 */
        Call<Void> insertData = provideHelper.insertData(new InsertDataModel(sName,sRoll,sReg,sSub,sPhone,sImage,sAddress));

        insertData.enqueue(new Callback<Void>() {
            @Override
            public void onResponse(Call<Void> call, Response<Void> response) {
                Toast.makeText(DataInsert.this, "Data Insert success", Toast.LENGTH_SHORT).show();
                progressbar.setVisibility(View.GONE);
            }

            @Override
            public void onFailure(Call<Void> call, Throwable throwable) {
                Toast.makeText(DataInsert.this, "Data Insert Failed", Toast.LENGTH_SHORT).show();
                progressbar.setVisibility(View.GONE);
